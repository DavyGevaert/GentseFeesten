    ...
    fun doOperationsOnThread_Create_Events(){
        thread {
            ...
            for (i in 0 until jsonArray.length()){
                ...
                // initialize Event class and assign values
                var event = Event()
                ...
                if (fields.has("offer_pricecurrency")){
                    ...
                    event.offer_pricecurrency = offer_pricecurrency
                }
                ...
                if (fields.has("image_thumbnail")){
                    ...
                    event.image_thumbnail = image_thumbnail
                }
                ...
                if (fields.has("offer_description")){
                    ...
                    event.offer_description = offer_description
                }
                ...
                if (fields.has("image_caption")){
                    ...
                    event.image_caption = image_caption
                }
